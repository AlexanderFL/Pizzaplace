...
void
ManagerService::replaceToppingInFile(const Topping &topping, int index)
{
...
*/
void
ManagerService::containsOnlyAlpha(string s)
{
...
void
ManagerService::validPrice(int p)
{
	if (p <= 0)
	{
		throw InvalidPrice();
...
void
ManagerService::validProcent(int p)
{
	if (p <= 0 || p >= 100)
	{
		throw InvalidPrice();
...
void
ManagerService::validateOffer(const Offer &offer)
{
