...
template<class Repos>
inline void
Data::WriteMultipleLinesToFile(vector<Repos> repVec) const
{
    Repos rep;
...
template<class Repos>
inline Repos
Data::RetrieveFromFile(int index)
{
...
template<class Repos>
inline void
Data::RemoveFromFileAtIndex(int index)
{
...
template<class Repos>
inline void
Data::ModifyFileAtIndex(int index, Repos modification)
{
    vector<Repos> vec = RetrieveAllFromFile<Repos>();
